    ...
    public class ManageListingsComponentSteps
    {
        ...
        public void ValidateShareSkillAdded(SkillModel skill)
        {
            ...
            try
            {
                ...
                Assert.AreEqual(skill.title, newTitleAddedCell, "Actual and expected share skill do not match. Share skill not added!!");
            }
            catch (Exception ex)
            {
                Assert.Fail();
        ...
        public void ValidateShareSkillNotAdded(SkillModel skill)
        {
            ...
            try
            {
                ...
                string newTitleAddedCell = ManageListingsComponentObj.GetTitle();
                Assert.AreNotEqual(skill.title, newTitleAddedCell, "Actual and expected share skill do not match. Share skill added!!");
            }
            catch (Exception ex)
            {
                Assert.Fail();
